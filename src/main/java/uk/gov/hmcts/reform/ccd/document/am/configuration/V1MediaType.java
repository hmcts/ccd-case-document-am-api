...
public class V1MediaType extends MediaType {
    ...
    public static final String V1_HAL_DOCUMENT_COLLECTION_MEDIA_TYPE_VALUE = "application/vnd.uk.gov.hmcts.ccd-case-document-am-api.document-collection.v1+hal+json;charset=UTF-8";
