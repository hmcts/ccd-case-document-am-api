...
public class StoredDocumentHalResource extends ResourceSupport {
    ...
    public void addLinks(UUID documentId) {
        add(linkTo(methodOn(CaseDocumentAmController.class).getDocumentbyDocumentId("dsds", documentId, "DummyAuthorization", "323", "caseworker-1")).withSelfRel());
        add(linkTo(methodOn(CaseDocumentAmController.class).getDocumentBinaryContentbyDocumentId("dsds", documentId, "DummyAuthorization","323", "caseworker-1")).withRel("binary"));
    }
