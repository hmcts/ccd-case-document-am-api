...
Feature: F-004: Upload Document With Binary Content
  ...
  @S-048 # This is the test need to be done manually
...
#    And   the response has all the details as expected.
#
  @S-049 # This is the test need to be done manually
...
#    And   the response has all the details as expected.
  ...
  @S-050 # should be picked up automatically by the freamework as suggested by CCD team
