...
class ResponseHelperTest {
    ...
    void shouldGetToResponseEntity() {
        ...
        ResponseEntity responseEntity = new ResponseEntity<StoredDocumentHalResource>(resource, getHttpHeaders(), HttpStatus.OK);
        ResponseEntity result = ResponseHelper.toResponseEntity(responseEntity, UUID.fromString("f565abb5-c337-4ccb-ba78-1c43989e3bd6"));
